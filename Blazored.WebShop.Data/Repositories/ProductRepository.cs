    ...
    public class ProductRepository : IProductRepository
    {
        ...
        public ProductRepository()
        {
            ...
            _products = new List<Product>
            {
                ...
                new Product{ Id = 57092265, Brand = "Cinnamon Toast", Name = "Chocolate Toast Crunch", Price = 50, ImageUrl = "/images/products/chocolate_toast_crunch.png", Description = "You asked, we delivered. The treasured Chocolate Toast Crunch is back by popular demand. Made with cocoa and cinnamon, this cereal delivers on the beloved cinnamon-sugar flavor combination with an epic chocolatey twist."}
            };
        }
